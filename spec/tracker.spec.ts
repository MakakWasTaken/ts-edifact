...
describe('Tracker', () => {
  ...
  it("shouldn't accept unknown segments", () => {
    tracker = new Tracker([{ content: 'AAA', mandatory: true, repetition: 1 }])
    ...
    tracker = new Tracker([
      {
        content: [
          {
            content: [{ content: 'AAA', mandatory: true, repetition: 1 }],
            mandatory: true,
            repetition: 3,
          },
          { content: 'BBB', mandatory: false, repetition: 1 },
  ...
  it('should throw when omitting a mandatory segment after probing for a mandatory group repetition', () => {
    ...
    tracker = new Tracker([
      {
        content: [{ content: 'AAA', mandatory: false, repetition: 1 }],
        mandatory: true,
        repetition: 5,
      },
    ...
    tracker = new Tracker([
      {
        content: [
          ...
          {
            content: [{ content: 'BBB', mandatory: false, repetition: 5 }],
            mandatory: false,
            repetition: 1,
          },
        ],
